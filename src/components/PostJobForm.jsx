...
import { CircleCheckFill, Clock, Xmark } from "@gravity-ui/icons";
    ...
    <div className="mx-auto max-w-7xl p-4 lg:p-6">
          ...
          <div className="rounded-xl bg-content2 p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {/* <p
                  className={`text-sm text-default-500 rounded-full ${company.status === "Approved" ? "bg-green-400" : "bg-amber-200"}`}
                >
                  {company.status}
                </p> */}
              </div>
      ...
      {company.status === "Approved" ? (
        <Form onSubmit={handleSubmit}>
          <div className="space-y-6">
            ...
            <section className="rounded-2xl border p-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <FieldGroup className="space-y-2">
                  <Label htmlFor="textarea-requirements">
                    Job Requirements
                  </Label>
                  <TextArea
          ...
          <p className="text-red-500 text-center">Your company is not approved yet. Please Wait for approval.</p>
        </div>}
    </div>
  );
}
